![image](https://github.com/DenisStepanidenko/AtonProblems/assets/110686828/0f5313d3-1f3d-417a-9684-e279848488b4)# Тестовое задание для стажера (Java-разработчик в команду корпоративной шины данных и микосервисов) 
***
# Описание задачи 
In memory simple DB  
...
# Решение задачи
На всякий случай загрузил код на GitHub, если так удобнее его смотреть, то можно тыкнуть по [ссылочке]()
